...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../lib/p5.sound.js":[function(require,module,exports) {
...
(function (modules) {
  ...
  !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    ...
    return a.prototype.set = function (t, e, n) {
      ...
      var e = [];
      if (this.isUndef(t.defaults) || (e = Object.keys(t.defaults)), !this.isUndef(t._super)) for (var n = this._collectDefaults(t._super), o = 0; o < n.length; o++) {
      ...
      if (this.isObject(t) && this.isObject(e)) {
        ...
        for (var o in t) {
          n[o] = this.defaultArg(e[o], t[o]);
        }

        for (var i in e) {
          n[i] = this.defaultArg(t[i], e[i]);
        }
      ...
      var o = {};
      if (1 === t.length && this.isObject(t[0])) o = t[0];else for (var i = 0; i < e.length; i++) {
        o[e[i]] = t[i];
      }
  ...
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(18)], __WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
    ...
    return !window.hasOwnProperty("AudioContext") && window.hasOwnProperty("webkitAudioContext") && (window.AudioContext = window.webkitAudioContext), o.Context = function (t) {
      for (var e in o.Emitter.call(this), t = t || new window.AudioContext(), this._context = t, this._context) {
      ...
      for (var e = this._context.createBuffer(1, 128, this._context.sampleRate), n = e.getChannelData(0), o = 0; o < n.length; o++) {
        n[o] = t;
      }
  ...
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = function (o) {
    ...
    return o.Emitter = function () {
      ...
      for (var i = t.split(/\W+/), r = 0; r < i.length; r++) {
        if (t = i[r], this._events.hasOwnProperty(t)) if (o.prototype.isUndef(e)) this._events[t] = [];else for (var n = this._events[t], s = 0; s < n.length; s++) {
          n[s] === e && n.splice(s, 1);
        }
      }
      ...
      if (this._events) {
        ...
        if (this._events.hasOwnProperty(t)) for (var i = this._events[t], r = 0, n = i.length; r < n; r++) {
          i[r].apply(this, e);
        }
      }
    ...
    "function" != typeof AudioWorkletNode && (self.AudioWorkletNode = function (e, t, r) {
      ...
      return fetch(e).then(function (e) {
        ...
        var r = {
          ...
          registerProcessor: function registerProcessor(e, t) {
            f(n.$$context)[e] = {
              realm: o,
              context: r,
              Processor: t,
  ...
  !function (e, t) {
    ...
    return r.prototype._moved = function (e) {
      ...
      return function e(t, n, i) {
        if (Array.isArray(t) || NodeList && t instanceof NodeList) for (var d = 0; d < t.length; d++) {
          e(t[d], n, i);
        } else if ("string" == typeof t) e(document.querySelectorAll(t), n, i);else if (t.jquery && "function" == typeof t.toArray) e(t.toArray(), n, i);else if (Element && t instanceof Element) {
          var o = new r(t, i);
          n.push(o);
        }
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../lib/p5.sound.js"], null)
//# sourceMappingURL=/p5.sound.919980a7.js.map